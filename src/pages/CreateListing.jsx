  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form>
            ...
            maxLength="32" minLength="10" required className='w-full px-4 py-2 text-xl
            ...
            <div className='flex space-x-6 mb-6'>
                <div>
                    ...
                    onChange={onChange} min="1" max="50" required className='w-full px-4
            ...
            <textarea type="text" id='description' value={description} onChange={onChange} placeholder='describe property' 
            required className='w-full px-4 py-2 text-xl
            text-gray-700 bg-white border border-gray-300 rounded transition duration-150
            ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'/>
...
<p className='text-lg font-semibold'>Offer</p>
            ...
            <div className="flex items-center mb-6">
                <div className="">
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        ...
                        min="50" max="400000000" required className='w-full px-4 py-2 text-xl text-gray-700
                        bg-white border-gray-300 rounded transition duration-150 ease-in-out
            ...
            <div className="flex items-center mb-6">
                <div className="">
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        ...
                        min="50" max="400000000" required={offer} className='w-full px-4 py-2 text-xl text-gray-700
                        bg-white border-gray-300 rounded transition duration-150 ease-in-out
                        focus:text-gray-700 focus:bg-white focus:border-slate-600'/>
            ...
            <div className='mb-6'>
                ...
                <input type="file" id="images" onChange={onChange} 
                    ...
                    focus:bg-white focus:border-slate-600 ease-in-out'/>
            </div>
